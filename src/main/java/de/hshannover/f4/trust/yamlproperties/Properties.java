...
public class Properties {
	...
	@SuppressWarnings("unchecked")
	private void addToRootMap(String propertyPath, Object propertyValue) throws PropertyException {
		// split propertyPath
		String[] propertyKeyArray = propertyPath.split("\\.");
	...
	public void set(String propertyPath, Object propertyValue) throws PropertyException {
		...
		LOG.debug("Set the property value: " + propertyValue + " on key: " + fullPropertyPath);
	}
